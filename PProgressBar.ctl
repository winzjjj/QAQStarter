...
Private Sub UserControl_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Enabled = True Then RaiseEvent MouseDown(Button, Shift, X, Y, X / UserControl.Width)
End Sub

Private Sub UserControl_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Enabled = True Then RaiseEvent MouseMove(Button, Shift, X, Y, X / UserControl.Width)
End Sub

Private Sub UserControl_MouseUp(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Enabled = True Then RaiseEvent MouseUp(Button, Shift, X, Y, X / UserControl.Width)
End Sub
