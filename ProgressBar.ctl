...
'软件名称：百度音乐小偷
'软件功能：一般MP3搜索，歌手列表，百度排行分类，歌曲地址显示，歌曲下载，LRC同步等……
'开发周期：一周（边上班边思考，其实没写多久，呵呵）
'开发作者：小蒲 QQ706029 希望大家可以加入我的群讨论 31044377
'个人主页：www.xxpig.cn 新站，没多少内容，不过我会把我编写的程序全部放上去
'UI界面没时间写，只是编写了主程序，代码不是很理想……
Option Explicit
